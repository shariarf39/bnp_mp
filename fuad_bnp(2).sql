...
INSERT INTO `contact_messages` (`id`, `name`, `email`, `phone`, `subject`, `message`, `attachment`, `is_read`, `created_at`, `updated_at`) VALUES
(1, 'Fahim Shariar', 'shariarfahim21@gmail.com', '01892382840', 'support', 'vhcvxcv', NULL, 1, '2026-01-13 13:02:14', '2026-01-13 13:02:26'),
(2, 'Fahim Shariar', NULL, '+8801892382840', 'support', 'test', NULL, 1, '2026-01-14 02:45:27', '2026-01-14 06:04:27'),
(3, 'Fahim Shariar', NULL, '01892382840', 'volunteer', 'test data sent', NULL, 0, '2026-01-14 04:49:48', '2026-01-14 04:49:48'),
(4, 'Fahim Shariar', NULL, '01892382840', NULL, 'test pictuer', 'contact_attachments/1768390459_574307416_122184782216563907_231527346601289901_n.jpg', 0, '2026-01-14 05:34:19', '2026-01-14 05:34:19'),
(5, 'Fahim Shariar', NULL, '01892382840', NULL, 'test cintact again', 'contact_attachments/1768391100_mirja abbas.png', 0, '2026-01-14 05:45:00', '2026-01-14 05:45:00'),
(6, 'Fahim Shariar', NULL, '01892382840', NULL, 'dgfdsfdsds', 'contact_attachments/1768391360_1b15c9f0-d51c-40e3-a6e9-aae5951adb12.png', 1, '2026-01-14 05:49:20', '2026-01-14 06:04:38'),
(7, 'Fahim Shariar', NULL, '01892382840', NULL, 'dfgfd', 'contact_attachments/1768391454_Promotional_Video_Generation.mp4', 1, '2026-01-14 05:50:54', '2026-01-14 06:03:42'),
(8, 'Fahim Shariar', NULL, '01892382840', 'volunteer', 'fghfdv', 'contact_attachments/1768392050_574307416_122184782216563907_231527346601289901_n.jpg', 1, '2026-01-14 06:00:50', '2026-01-14 06:04:50'),
(9, 'Fahim Shariar', NULL, '01892382840', NULL, 'vxbvc', NULL, 0, '2026-01-15 03:29:02', '2026-01-15 03:29:02'),
(10, 'Fahim Shariar', NULL, '01892382840', NULL, 'test after Ui changed', 'contact_attachments/1768471342_1768391360_1b15c9f0-d51c-40e3-a6e9-aae5951adb12.png', 1, '2026-01-15 04:02:22', '2026-01-15 04:02:46');

-- --------------------------------------------------------

--
-- Table structure for table `contact_slides`
--

CREATE TABLE `contact_slides` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `image` varchar(255) NOT NULL,
...
--
-- Dumping data for table `contact_slides`
--

INSERT INTO `contact_slides` (`id`, `image`, `title`, `order`, `active`, `created_at`, `updated_at`) VALUES
(1, 'contact-slides/8q3Q60M9pkGTUPeJVyBqy6BeevW38eFeO9uJOkpH.jpg', NULL, 0, 1, '2026-01-15 04:13:53', '2026-01-15 04:13:53'),
(2, 'contact-slides/8vh6KeaVUpNKUgcQInVbB788f4iFi0gFjNz19cRC.png', NULL, 0, 1, '2026-01-15 04:14:32', '2026-01-15 04:14:32'),
(3, 'contact-slides/bT3aebH9tKOhTraAGGZf8HiwZND9SoEDUtUyaAxi.webp', NULL, 0, 1, '2026-01-15 04:28:53', '2026-01-15 04:28:53'),
(4, 'contact-slides/vXgubWnNnZ2cTO6rU7r98PsWlZEzCOw7YX8AZAr9.jpg', NULL, 0, 1, '2026-01-15 04:51:31', '2026-01-15 04:51:31'),
(5, 'contact-slides/xBCwEEkdMCWVssOzv7ODr35DYslbhZZmOMVLCjjE.jpg', NULL, 0, 1, '2026-01-15 04:52:02', '2026-01-15 04:52:02');
...
(10, '2026_01_14_112946_add_attachment_to_contact_messages_table', 4),
(11, '2026_01_15_000001_create_contact_slides_table', 5);
...
('DjaavergZU0Br0X17auJtL3GQZy473TmKdP2mvPp', 1, '::1', 'Mozilla/5.0 (iPhone; CPU iPhone OS 15_0 like Mac OS X) AppleWebKit/603.1.30 (KHTML, like Gecko) Version/17.5 Mobile/15A5370a Safari/602.1', '', 1768474342);
...
--
-- Indexes for table `contact_slides`
--
ALTER TABLE `contact_slides`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `contact_slides`
--
ALTER TABLE `contact_slides`
