...
@section('title', 'নতুন যোগাযোগ স্লাইড')
@section('page-title', 'নতুন যোগাযোগ স্লাইড যুক্ত করুন')
...
@section('content')
    <div class="form-card">
        ...
        <form action="{{ route('admin.contact-slides.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            
            <div class="form-group">
                <label><i class="fas fa-image"></i> ছবি নির্বাচন করুন *</label>
                <div class="image-upload-area" onclick="document.getElementById('image').click()">
                    <i class="fas fa-cloud-upload-alt"></i>
                    <p>ক্লিক করুন অথবা ছবি ড্রাগ করুন</p>
            ...
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" value="{{ old('title') }}" placeholder="ছবির শিরোনাম">
